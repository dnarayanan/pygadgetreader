...
halogalaxystruct2 = np.dtype([('id', np.int64),
                              ('pos', np.float32, (6,)),
                              ('corevel', np.float32, (3,)),
                              ('bulkvel', np.float32, (3,)),
                              ('m', np.float32),
...
def getRSformat(obj):
    ...
    if obj.galaxies == 0:
        if obj.format_revision == 0:
            ...
            if obj.debug:
                print('returning halostruct1')
            return halostruct1

        elif obj.format_revision == 2:
            if obj.debug:
                print('returning halostruct2')
            return halostruct2
        ...
        if obj.format_revision == 0:
            ...
            if obj.debug:
                print('returning halogalaxystruct1')
            return halogalaxystruct1

        elif obj.format_revision == 2:
            if obj.debug:
                print('returning halogalaxystruct2')
            return halogalaxystruct2
